...
namespace OpenExcel.OfficeOpenXml.Internal
{
    internal class DocumentStyles
    {
        ...
        public uint MergeAndRegisterFont(Font fNew, UInt32Value baseFontsIdx)
        {
            Stylesheet ss = EnsureStylesheet();
            uint ret = MergeAndRegisterStyleElement<Font, Fonts>(fNew, ss.Fonts, MergeFont, GenericElementCompare, baseFontsIdx);
        ...
        public uint MergeAndRegisterBorder(Border bNew, UInt32Value baseBordersIdx)
        {
            ...
            uint ret = MergeAndRegisterStyleElement<Border, Borders>(bNew, ss.Borders,
                fnCombine, GenericElementCompare, baseBordersIdx);
        ...
        public uint MergeAndRegisterFill(Fill fNew, UInt32Value baseFillsIdx)
        {
            ...
            uint ret = MergeAndRegisterStyleElement<Fill, Fills>(fNew, ss.Fills,
                fnCombine, fnCompare, baseFillsIdx);
        ...
        public uint MergeAndRegisterCellFormat(CellFormat cfNew, UInt32Value baseCellXfsIdx)
        {
            ...
            uint ret = MergeAndRegisterStyleElement<CellFormat, CellFormats>(cfNew, ss.CellFormats,
                fnCombine, fnCompare, baseCellXfsIdx);
