        ...
        public ExcelStyle Style
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    c.StyleIndex = this.Worksheet.Document.Styles.MergeAndRegisterCellFormat(cfNew, c.StyleIndex);
            ...
            else
            {
                ...
                if (valueType == typeof(DateTime))
                {
                    ...
                    if (!hasDateFormat)
                    {
                        ...
                        uint cfIdxDate = this.Worksheet.Document.Styles.MergeAndRegisterCellFormat(cfDate, c.StyleIndex);
                ...
                else if (ValueChecker.IsNumeric(valueType))
                {
                    if (hasDateFormat)
                    {
                        ...
                        uint cfIfxGeneric = this.Worksheet.Document.Styles.MergeAndRegisterCellFormat(cfGeneric, c.StyleIndex);
